...
from userbot.utils import edit_or_reply, load_module, zed_cmd, remove_plugin, reply_id


@zed_cmd(pattern="تنصيب$")
async def _(event):
    if event.fwd_from:
        return
...
@zed_cmd(pattern="الغاء تنصيب (?P<shortname>\w+)")
