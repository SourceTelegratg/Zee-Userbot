...
from userbot.utils import bash, edit_or_reply, zed_cmd
...
@zed_cmd(pattern="(?:alive|on)\s?(.)?")
async def amireallyalive(alive):
    user = await alive.client.get_me()
    uptime = await get_readable_time((time.time() - StartTime))
    output = (
        f"**[Zee-Userbot](https://github.com/Zed-Thon/Zee-Userbot) Sedang Berjalan.**\n\n"
        f"**{alive_text}**\n\n"
