...
from userbot.utils import bash, deEmojify, zed_cmd
...
CMD_HELP.update(
    {
        ...
        \n  •  **Example  : **{cmd}tweet @zeafeya.ganteng (harus pake . [titik])\
    "
    }
)
