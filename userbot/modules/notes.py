...
from userbot.utils import edit_or_reply, edit_delete, zed_cmd
from userbot.events import register
from asyncio import sleep


@zed_cmd(pattern="notes$")
