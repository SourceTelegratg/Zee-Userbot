...
@man_cmd(pattern="رفع مشرف(?:\s|$)([\s\S]*)", group_only=True)
...
async def promote(event):
    ...
    if not user:
        return
    eventman = await edit_or_reply(event, "**╮ ❐.. جـاري ࢪفـع الشخـص ..❏╰**")
    try:
        await event.client(EditAdminRequest(event.chat_id, user.id, new_rights, rank))
    except BadRequestError:
        return await eventman.edit(NO_PERM)
    await edit_delete(eventman, "**- تم رفـع الشخص مشـرف .. بنجـاح ✓**", 30)


@man_cmd(pattern="تنزيل مشرف(?:\s|$)([\s\S]*)", group_only=True)
...
async def demote(event):
    ...
    if not user:
        return
    eventman = await edit_or_reply(event, "**╮ ❐.. جـاري تنزيـل الشخـص ..❏╰**")
    ...
    try:
        ...
        return await eventman.edit(NO_PERM)
    await edit_delete(eventman, "**- تم تنزيـل الشخـص مشرف .. بنجـاح✓**", 30)


@man_cmd(pattern="حظر(?:\s|$)([\s\S]*)", group_only=True)
...
async def ban(bon):
    ...
    if not user:
        return
    man = await edit_or_reply(bon, "**╮ ❐... جـاࢪِ الحـظـࢪ ...❏╰**")
    try:
...
@man_cmd(pattern="الغاء حظر(?:\s|$)([\s\S]*)", group_only=True)
...
async def nothanos(unbon):
    ...
    man = await edit_or_reply(unbon, "**╮ ❐.. جـاري الغاء حـظࢪه ..❏╰**")
    ...
    try:
        ...
        await edit_delete(man, "** - تم الغـاء الحظـر .. بنجـاح✓**")
    except UserIdInvalidError:
        await edit_delete(man, "`Sepertinya Terjadi ERROR!`")


@man_cmd(pattern="كتم(?: |$)(.*)", group_only=True)
...
async def spider(spdr):
    ...
    man = await edit_or_reply(spdr, "**╮ ❐ ... جـاࢪِ الکتم ... ❏╰**")
...
@man_cmd(pattern="الغاء كتم(?: |$)(.*)", group_only=True)
...
async def unmoot(unmot):
    ...
    man = await edit_or_reply(unmot, "**╮ ❐ ... جـاࢪِ الغـاء الکتم ... ❏╰**")
...
@man_cmd(pattern="الغاء الكتم العام(?: |$)(.*)")
...
async def ungmoot(un_gmute):
    ...
    man = await edit_or_reply(un_gmute, "**╮ ❐ ... جـاࢪِ الغـاء الکتم العـام ... ❏╰**")
...
async def gspider(gspdr):
    ...
    man = await edit_or_reply(gspdr, "**╮ ❐ ... جـاࢪِ الکتم عـام ... ❏╰**")
...
@man_cmd(pattern="المحذوفين(?: |$)(.*)", group_only=True)
...
@man_cmd(pattern="المشرفون$", group_only=True)
...
@man_cmd(pattern="تثبيت( loud|$)", group_only=True)
...
@man_cmd(pattern="الغاء تثبيت( all|$)", group_only=True)
...
@man_cmd(pattern="طرد(?: |$)(.*)", group_only=True)
