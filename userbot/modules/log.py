...
@zed_handler(incoming=True, func=lambda e: e.is_private)
...
@zed_handler(incoming=True, func=lambda e: e.mentioned)
...
@zed_cmd(pattern="save(?: |$)(.*)", allow_sudo=False)
...
@zed_cmd(pattern="log$", allow_sudo=False)
...
@zed_cmd(pattern="nolog$", allow_sudo=False)
...
@zed_cmd(pattern="pmlog (on|off)$", allow_sudo=False)
...
@zed_cmd(pattern="gruplog (on|off)$", allow_sudo=False)
