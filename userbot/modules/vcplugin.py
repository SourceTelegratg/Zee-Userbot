...
@man_cmd(pattern="صوت(?:\s|$)([\s\S]*)", group_only=True)
async def vc_play(event):
    ...
    if (
        ...
        botman = await edit_or_reply(event, "**╮ جـارِ البحث ؏ـن المقطـٓـع الصـٓـوتي... 🎧♥️╰**")
        ...
        botman = await edit_or_reply(event, "📥 **- جاري التحميل...**")
...
@man_cmd(pattern="فيد(?:\s|$)([\s\S]*)", group_only=True)
...
@man_cmd(pattern="انهاء$", group_only=True)
...
@man_cmd(pattern="تخطي(?:\s|$)([\s\S]*)", group_only=True)
...
@man_cmd(pattern="تمهل$", group_only=True)
...
@man_cmd(pattern="تابع$", group_only=True)
...
@man_cmd(pattern=r"الصوت(?: |$)(.*)", group_only=True)
...
@man_cmd(pattern="التشغيل$", group_only=True)
