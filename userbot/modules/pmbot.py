...
@asst_cmd(pattern="^/اذاعه$", from_users=OWNER_ID)
...
@asst_cmd(pattern="^/حظر\\s+([\\s\\S]*)", from_users=OWNER_ID)
...
@asst_cmd(pattern="^/الغاء حظر(?:\\s|$)([\\s\\S]*)", from_users=OWNER_ID)
...
@asst_cmd(pattern="^/كشف$", from_users=OWNER_ID)
...
@zed_cmd(pattern="(set|reset) pmbot(?: |$)(\\w*)")
