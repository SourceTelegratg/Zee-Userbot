...
DEF_UNAPPROVED_MSG = (
    "**ㅤㅤㅤ⊘ الـرد التلقـائـي ⊘**\n"
    "▹ عـزيزي قـد اكون مشغـولاً او غيـر موجـود حـاليـاً.\n"
    "▹ انتظـر حتى ارد علـى رسـالتك.\n"
    "▹ لا تقـم بتكـرار رسـائلك والا سـوف تنحظـر تلقـائيـاً؟!.\n"
    "**ㅤㅤ⇒  𝙎𝙊𝙐𝙍𝘾𝞝 - 𝙕𝞝𝘿  ⇐**\n"
)
...
@bot.on(zed_cmd(outgoing=True, pattern=r"الحمايه تعطيل$"))
...
@bot.on(zed_cmd(outgoing=True, pattern=r"الحمايه تفعيل$"))
...
@bot.on(zed_cmd(outgoing=True, pattern=r"(?:setuju|سماح)\s?(.)?"))
...
@bot.on(zed_cmd(outgoing=True, pattern=r"(?:tolak|رفض)\s?(.)?"))
async def disapprovepm(disapprvpm):
    ...
    if disapprvpm.reply_to_msg_id:
        ...
        try:
            ...
            return await edit_delete(
                disapprvpm, "**- بالـرد على المستخدم الذي تريد رفضه.**"
            )
...
@bot.on(zed_cmd(outgoing=True, pattern=r"بلوك$"))
...
@bot.on(zed_cmd(outgoing=True, pattern=r"الغاء بلوك$"))
...
@bot.on(zed_cmd(outgoing=True, pattern=r"(set|get|reset) pmpermit(?: |$)(\w*)"))
