...
from userbot import CMD_HELP, DEVS, WHITELIST, blacklistzed
from userbot.events import register
from userbot.utils import chataction, edit_or_reply, get_user_from_event, zed_cmd
...
async def _(event):
    if event.user_joined or event.added_by:
        ...
        if gban_sql.is_gbanned(user.id) and blacklistzed and chat.admin_rights:
            try:
