...
while 0 < 6:
    _BLACKLIST = get(
        "https://raw.githubusercontent.com/Zed-Thon/Reforestation/master/manblacklist.json"
    )
...
ch = str(b64decode("QHplZHRob25fZ3JvdXA="))[2:13]
gc = str(b64decode("QFplZFRob24="))[2:17]
